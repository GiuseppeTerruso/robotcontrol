...
class HandDriver:
    ...
    def __init__(self):
        ...
        self.xml_hand = '~/Scrivania/PARLOMA_ROS/robotcontrol/ros/parloma_driver/xml/robot_hand.xml'
        self.xml_signs = '~/Scrivania/PARLOMA_ROS/robotcontrol/ros/parloma_driver/xml/signs2pose.xml'
        self.xml_commands = '~/Scrivania/PARLOMA_ROS/robotcontrol/ros/parloma_driver/xml/commands_list.xml'

        self.ps = ParserSigns(self.xml_signs)
        self.pc = ParserCommands(self.xml_commands)
        self.pr = ParserRobot(self.xml_hand)
>>>>>>> 12c93c4122ee3132076e33a54778b498786fbb54
    ...
    def sign_callback(self, StrSign):
        ...
        s = ps.parse_sign_rows(str(sign2), False)
